...
public class NavDrawerAdapter extends
	...
	public NavDrawerAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup,
		...
		LinearLayout drawerHeader = (LinearLayout) viewGroup.findViewById(R.id.drawerHeader);

		List<ColorStyleObject> colorStyleList = ColorStyleObject.listAll(ColorStyleObject.class);

		drawerHeader.setBackgroundColor(Color.parseColor(colorStyleList.get(0).getDrawerHeadColor()));
	...
	private void setText(TextView textView, final int i, Drawable drawable) {
		textView.setText(mData.get(i).getTitle(textView.getContext()));
